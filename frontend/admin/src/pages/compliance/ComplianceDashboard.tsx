    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <header className="mb-10 flex justify-between items-end">
        <div>
          ...
          <p className="text-muted-foreground font-medium text-lg">Preparação para auditorias SOC 2 e ISO 27001.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {frameworks?.map((fw: any) => (
              <div key={fw.id} className="bg-card border border-border rounded-3xl p-8 hover:border-emerald-300 transition-all group">
                ...
                <button className="w-full mt-8 py-3 rounded-2xl bg-foreground text-white text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 transition-colors flex items-center justify-center gap-2">
        ...
        <div className="space-y-6">
           <div className="bg-card border border-border rounded-3xl p-6">
              ...
              <div className="space-y-4">
                 {[
                   ...
                   <div key={i} className="flex justify-between items-center p-3 rounded-xl hover:bg-secondary transition-colors">
                      <div>
                         <div className="font-bold text-xs">{item.t}</div>
                         <div className="text-[10px] text-muted-foreground">{item.d}</div>
                      </div>
           ...
           <div className="bg-emerald-900 text-white rounded-3xl p-8 relative overflow-hidden">
              ...
              <button className="bg-card text-emerald-900 px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-emerald-50 transition-colors relative z-10">
                Ver Políticas
              </button>
           </div>

           <div className="p-6 bg-secondary rounded-3xl border border-border">
