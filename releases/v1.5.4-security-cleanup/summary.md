...
- **Version:** v1.5.4-security-cleanup
- **Branch:** feature/v1.5.4-security-cleanup
- **Commit:** 73805b04324ce438430e6fcf8932b249e7549798
- **Base URL:** http://localhost:18080
- **Start Time:** 2026-05-09T01:18:12Z
- **End Time:** 2026-05-09T01:21:23Z
- **Total Duration:** 191s
...
| `validate-rag-local-multiclient.sh` | OK | Yes | 2s | [view](logs/validate-rag-local-multiclient.sh.log) |
...
| `validate-observability-local.sh` | OK | Yes | 23s | [view](logs/validate-observability-local.sh.log) |
...
- Check logs: `ls -R /home/kleber/llm-inference-stack/artifacts/local-production-validation/20260508T221812/logs/`
- Tail all logs: `tail -f /home/kleber/llm-inference-stack/artifacts/local-production-validation/20260508T221812/logs/*.log`
