...
- **Version:** v1.6.3-readiness-cleanup
- **Branch:** feature/v1.6.3-readiness-cleanup
- **Commit:** b34667b7061ab939129350ab231667ceca30b08f
- **Base URL:** http://localhost:18080
- **Start Time:** 2026-05-11T17:48:53Z
- **End Time:** 2026-05-11T17:52:11Z
- **Total Duration:** 198s
...
| `validate-admin-lab-local.sh` | OK | Yes | 22s | [view](logs/validate-admin-lab-local.sh.log) |
...
| `validate-plan-queues.sh` | OK | Yes | 10s | [view](logs/validate-plan-queues.sh.log) |
...
- Check logs: `ls -R /home/kleber/llm-inference-stack/artifacts/local-production-validation/20260511T144853/logs/`
- Tail all logs: `tail -f /home/kleber/llm-inference-stack/artifacts/local-production-validation/20260511T144853/logs/*.log`
