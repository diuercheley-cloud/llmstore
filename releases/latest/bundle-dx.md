...
| Script | Purpose |
|--------|---------|
| `scripts/legacy/agent-bundle-init.sh` | Initialize a new agent bundle project |
| `scripts/release/agent-bundle-sign.sh` | Sign agent bundles for distribution |
| `scripts/validators/agent-bundle-validate.sh` | Validate bundle integrity and compliance |
| `scripts/dev/agent-bundle-test.sh` | Run bundle tests in sandbox |
| `scripts/dev/agent-bundle-publish.sh` | Publish bundle to registry |
