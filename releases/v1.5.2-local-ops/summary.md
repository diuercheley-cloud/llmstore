...
- **Version:** v1.5.2-local-ops
- **Branch:** feature/v1.5.2-local-ops
- **Commit:** 07e2debed5fe1c1b431218b25fc4e7a08b5e7493
- **Base URL:** http://localhost:18080
- **Start Time:** 2026-05-08T22:33:39Z
- **End Time:** 2026-05-08T22:37:13Z
- **Total Duration:** 214s
...
| `validate-admin-lab-local.sh` | OK | Yes | 37s | [view](logs/validate-admin-lab-local.sh.log) |
| `validate-lmstudio-backend.sh` | OK | No | 13s | [view](logs/validate-lmstudio-backend.sh.log) |
...
| `validate-rag-local-multiclient.sh` | OK | Yes | 28s | [view](logs/validate-rag-local-multiclient.sh.log) |
...
| `validate-observability-local.sh` | OK | Yes | 17s | [view](logs/validate-observability-local.sh.log) |
...
- Check logs: `ls -R /home/kleber/llm-inference-stack/artifacts/local-production-validation/20260508T193339/logs/`
- Tail all logs: `tail -f /home/kleber/llm-inference-stack/artifacts/local-production-validation/20260508T193339/logs/*.log`
