...
- **Version:** v1.8.1-real-provider-validation
- **Branch:** feature/v1.8.1-real-provider-validation
- **Commit:** bb0949985785177966a44a3385bc178521d91611
- **Base URL:** http://localhost:18080
- **Start Time:** 2026-05-13T19:20:44Z
- **End Time:** 2026-05-13T19:23:46Z
- **Total Duration:** 182s
...
| `validate-api-keys-local.sh` | OK | Yes | 8s | [view](logs/validate-api-keys-local.sh.log) |
...
- Check logs: `ls -R /home/kleber/llm-inference-stack/artifacts/local-production-validation/20260513T162044/logs/`
- Tail all logs: `tail -f /home/kleber/llm-inference-stack/artifacts/local-production-validation/20260513T162044/logs/*.log`
