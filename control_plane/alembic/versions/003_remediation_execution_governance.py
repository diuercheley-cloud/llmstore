...
def upgrade() -> None:
    ...
    op.add_column(
        "remediation_executions", sa.Column("approved_by", sa.String(length=128), nullable=True)
    )
    op.add_column(
        "remediation_executions",
    ...
    op.add_column(
        "remediation_executions", sa.Column("idempotency_key", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "remediation_executions", sa.Column("error_code", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "remediation_executions", sa.Column("error_message", sa.String(length=1000), nullable=True)
    )
    op.add_column(
        "remediation_executions", sa.Column("correlation_id", sa.String(length=255), nullable=True)
    )

    op.create_index(
        op.f("ix_remediation_executions_idempotency_key"),
        "remediation_executions",
        ["idempotency_key"],
        unique=True,
    )
    ...
    op.add_column(
        "remediation_execution_steps", sa.Column("error_code", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "remediation_execution_steps",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_remediation_executions_idempotency_key"), table_name="remediation_executions"
    )
