...
def upgrade() -> None:
    ...
    op.add_column('billing_plans', sa.Column('tts_enabled', sa.Boolean(), server_default='false', nullable=False))
    op.add_column('billing_plans', sa.Column('tts_chars_per_request', sa.Integer(), server_default='500', nullable=False))
    op.add_column('billing_plans', sa.Column('tts_chars_per_day', sa.Integer(), server_default='5000', nullable=False))
    op.add_column('billing_plans', sa.Column('tts_chars_per_month', sa.Integer(), server_default='50000', nullable=False))
    op.add_column('billing_plans', sa.Column('tts_audio_retention_days', sa.Integer(), server_default='7', nullable=False))
    op.add_column('billing_plans', sa.Column('tts_max_files', sa.Integer(), server_default='100', nullable=False))

    # Add used_tts_chars to quota_counters
    op.add_column('quota_counters', sa.Column('used_tts_chars', sa.Integer(), server_default='0', nullable=False))

    # Create tts_usage_events table
    op.create_table('tts_usage_events',
    ...
    op.create_index(op.f('ix_tts_usage_events_client_id'), 'tts_usage_events', ['client_id'], unique=False)
    op.create_index(op.f('ix_tts_usage_events_created_at'), 'tts_usage_events', ['created_at'], unique=False)
