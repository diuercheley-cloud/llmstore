...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_runtime_node_heartbeats_node_id'), 'runtime_node_heartbeats', ['node_id'], unique=False)
    ...
    op.create_index(op.f('ix_runtime_model_placements_model_id'), 'runtime_model_placements', ['model_id'], unique=False)
    op.create_index(op.f('ix_runtime_model_placements_node_id'), 'runtime_model_placements', ['node_id'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['model_id'], ['model_registry.id'], ),
        sa.ForeignKeyConstraint(['selected_node_id'], ['runtime_nodes.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_runtime_routing_events_request_id'), 'runtime_routing_events', ['request_id'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['failed_node_id'], ['runtime_nodes.id'], ),
        sa.ForeignKeyConstraint(['target_node_id'], ['runtime_nodes.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_runtime_failover_events_request_id'), 'runtime_failover_events', ['request_id'], unique=False)
