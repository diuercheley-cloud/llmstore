...
def upgrade():
    op.add_column('billing_plans', sa.Column('weekly_token_quota', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('clients', sa.Column('weekly_token_quota', sa.Integer(), nullable=False, server_default='100000'))
