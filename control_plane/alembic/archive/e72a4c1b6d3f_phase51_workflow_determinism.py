...
def upgrade():
    ...
    op.create_index(
        op.f("ix_commercial_workflow_definitions_client_id"),
        "commercial_workflow_definitions",
        ["client_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["definition_id"],
            ["commercial_workflow_definitions.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_commercial_workflow_executions_session_id"),
        "commercial_workflow_executions",
        ["session_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["execution_id"],
            ["commercial_workflow_executions.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
