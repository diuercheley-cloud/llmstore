...
down_revision: str | None = "20260522_0091"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_team_members_team_id"), "agent_team_members", ["team_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_team_runs_team_id"), "agent_team_runs", ["team_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_team_runs_tenant_id"), "agent_team_runs", ["tenant_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["recipient_agent_id"], ["agent_definitions.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        op.f("ix_agent_team_messages_run_id"), "agent_team_messages", ["run_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_team_delegations_run_id"), "agent_team_delegations", ["run_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_shared_workspaces_tenant_id"),
        "agent_shared_workspaces",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_shared_workspaces_team_run_id"),
        "agent_shared_workspaces",
        ["team_run_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_team_traces_run_id"), "agent_team_traces", ["run_id"], unique=False
    )
