...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_adapter_promotion_workflows_client_id"),
        "adapter_promotion_workflows",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_workflows_registry_entry_id"),
        "adapter_promotion_workflows",
        ["registry_entry_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_workflows_input_hash"),
        "adapter_promotion_workflows",
        ["input_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_workflows_immutable_hash"),
        "adapter_promotion_workflows",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["client_id"], ["clients.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["workflow_id"], ["adapter_promotion_workflows.id"], ondelete="CASCADE"
        ),
    )
    op.create_index(
        op.f("ix_adapter_promotion_gate_results_client_id"),
        "adapter_promotion_gate_results",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_gate_results_workflow_id"),
        "adapter_promotion_gate_results",
        ["workflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_gate_results_immutable_hash"),
        "adapter_promotion_gate_results",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_adapter_promotion_stage_transitions_client_id"),
        "adapter_promotion_stage_transitions",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_stage_transitions_workflow_id"),
        "adapter_promotion_stage_transitions",
        ["workflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_stage_transitions_immutable_hash"),
        "adapter_promotion_stage_transitions",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_adapter_promotion_receipts_client_id"),
        "adapter_promotion_receipts",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_receipts_workflow_id"),
        "adapter_promotion_receipts",
        ["workflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_receipts_immutable_hash"),
        "adapter_promotion_receipts",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_adapter_promotion_rollbacks_client_id"),
        "adapter_promotion_rollbacks",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_rollbacks_workflow_id"),
        "adapter_promotion_rollbacks",
        ["workflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adapter_promotion_rollbacks_immutable_hash"),
        "adapter_promotion_rollbacks",
        ["immutable_hash"],
        unique=True,
    )
