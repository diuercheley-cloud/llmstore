...
down_revision: str | None = "20260522_0092"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_flow_definitions_tenant_id"),
        "agent_flow_definitions",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_flow_versions_flow_id"), "agent_flow_versions", ["flow_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_debug_sessions_run_id"), "agent_debug_sessions", ["run_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_debug_events_session_id"), "agent_debug_events", ["session_id"], unique=False
    )
