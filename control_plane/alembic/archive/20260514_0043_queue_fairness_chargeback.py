...
def upgrade():
    ...
    op.create_index(
        op.f("ix_commercial_queue_metrics_timestamp"),
        "commercial_queue_metrics",
        ["timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_queue_metrics_qos_tier"),
        "commercial_queue_metrics",
        ["qos_tier"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_queue_metrics_client_id"),
        "commercial_queue_metrics",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_queue_metrics_model"),
        "commercial_queue_metrics",
        ["model"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "estimated_opportunity_cost_brl", sa.Numeric(precision=18, scale=6), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_commercial_queue_chargebacks_period_start"),
        "commercial_queue_chargebacks",
        ["period_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_queue_chargebacks_period_end"),
        "commercial_queue_chargebacks",
        ["period_end"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_queue_chargebacks_qos_tier"),
        "commercial_queue_chargebacks",
        ["qos_tier"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_queue_chargebacks_client_id"),
        "commercial_queue_chargebacks",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_queue_chargebacks_model"),
        "commercial_queue_chargebacks",
        ["model"],
        unique=False,
    )
