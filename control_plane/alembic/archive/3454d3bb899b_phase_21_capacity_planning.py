...
def upgrade():
    ...
    op.create_index(
        op.f("ix_commercial_capacity_snapshots_cluster_id"),
        "commercial_capacity_snapshots",
        ["cluster_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_capacity_snapshots_model"),
        "commercial_capacity_snapshots",
        ["model"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_capacity_snapshots_node_id"),
        "commercial_capacity_snapshots",
        ["node_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_capacity_snapshots_provider"),
        "commercial_capacity_snapshots",
        ["provider"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_capacity_snapshots_qos_tier"),
        "commercial_capacity_snapshots",
        ["qos_tier"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_capacity_snapshots_timestamp"),
        "commercial_capacity_snapshots",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_commercial_capacity_forecasts_cluster_id"),
        "commercial_capacity_forecasts",
        ["cluster_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_capacity_forecasts_model"),
        "commercial_capacity_forecasts",
        ["model"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_capacity_forecasts_provider"),
        "commercial_capacity_forecasts",
        ["provider"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_capacity_forecasts_qos_tier"),
        "commercial_capacity_forecasts",
        ["qos_tier"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_commercial_autoscaling_recommendations_cluster_id"),
        "commercial_autoscaling_recommendations",
        ["cluster_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_autoscaling_recommendations_recommendation_type"),
        "commercial_autoscaling_recommendations",
        ["recommendation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_autoscaling_recommendations_target_identifier"),
        "commercial_autoscaling_recommendations",
        ["target_identifier"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_autoscaling_recommendations_target_scope"),
        "commercial_autoscaling_recommendations",
        ["target_scope"],
        unique=False,
    )
