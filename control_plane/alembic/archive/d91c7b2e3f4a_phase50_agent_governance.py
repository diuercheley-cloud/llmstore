...
def upgrade():
    ...
    op.create_index(
        op.f("ix_commercial_agent_profiles_client_id"),
        "commercial_agent_profiles",
        ["client_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["agent_id"],
            ["commercial_agent_profiles.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_commercial_agent_executions_parent_execution_id"),
        "commercial_agent_executions",
        ["parent_execution_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_agent_executions_session_id"),
        "commercial_agent_executions",
        ["session_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["execution_id"],
            ["commercial_agent_executions.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        op.f("ix_commercial_agent_memory_boundaries_tenant_id"),
        "commercial_agent_memory_boundaries",
        ["tenant_id"],
        unique=False,
    )
...
def downgrade():
    op.drop_index(
        op.f("ix_commercial_agent_memory_boundaries_tenant_id"),
        table_name="commercial_agent_memory_boundaries",
    )
    ...
    op.drop_index(
        op.f("ix_commercial_agent_executions_session_id"), table_name="commercial_agent_executions"
    )
    op.drop_index(
        op.f("ix_commercial_agent_executions_parent_execution_id"),
    ...
    op.drop_index(
        op.f("ix_commercial_agent_profiles_client_id"), table_name="commercial_agent_profiles"
    )
