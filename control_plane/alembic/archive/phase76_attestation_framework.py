...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_sovereign_execution_attestations_client_id"),
        "sovereign_execution_attestations",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sovereign_execution_attestations_attestation_type"),
        "sovereign_execution_attestations",
        ["attestation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sovereign_execution_attestations_subject_type"),
        "sovereign_execution_attestations",
        ["subject_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sovereign_execution_attestations_subject_ref"),
        "sovereign_execution_attestations",
        ["subject_ref"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sovereign_execution_attestations_attestation_status"),
        "sovereign_execution_attestations",
        ["attestation_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sovereign_execution_attestations_payload_hash"),
        "sovereign_execution_attestations",
        ["payload_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sovereign_execution_attestations_attestation_hash"),
        "sovereign_execution_attestations",
        ["attestation_hash"],
        unique=True,
    )
    op.create_index(
        op.f("ix_sovereign_execution_attestations_immutable_hash"),
        "sovereign_execution_attestations",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_attestation_trust_policies_client_id"),
        "attestation_trust_policies",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_trust_policies_immutable_hash"),
        "attestation_trust_policies",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_attestation_federation_bundles_client_id"),
        "attestation_federation_bundles",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_federation_bundles_bundle_status"),
        "attestation_federation_bundles",
        ["bundle_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_federation_bundles_bundle_hash"),
        "attestation_federation_bundles",
        ["bundle_hash"],
        unique=True,
    )
    op.create_index(
        op.f("ix_attestation_federation_bundles_immutable_hash"),
        "attestation_federation_bundles",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["attestation_id"], ["sovereign_execution_attestations.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["client_id"], ["clients.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_attestation_verification_results_client_id"),
        "attestation_verification_results",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_verification_results_attestation_id"),
        "attestation_verification_results",
        ["attestation_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_verification_results_verification_status"),
        "attestation_verification_results",
        ["verification_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_verification_results_immutable_hash"),
        "attestation_verification_results",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_attestation_receipts_client_id"),
        "attestation_receipts",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_receipts_attestation_id"),
        "attestation_receipts",
        ["attestation_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_receipts_payload_hash"),
        "attestation_receipts",
        ["payload_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_receipts_immutable_hash"),
        "attestation_receipts",
        ["immutable_hash"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_attestation_chain_links_client_id"),
        "attestation_chain_links",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_chain_links_attestation_id"),
        "attestation_chain_links",
        ["attestation_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attestation_chain_links_current_link_hash"),
        "attestation_chain_links",
        ["current_link_hash"],
        unique=True,
    )
    op.create_index(
        op.f("ix_attestation_chain_links_immutable_hash"),
        "attestation_chain_links",
        ["immutable_hash"],
        unique=True,
    )
