...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_agent_web_search_queries_agent_id", "agent_web_search_queries", ["agent_id"]
    )
    op.create_index(
        "ix_agent_web_search_queries_tenant_id", "agent_web_search_queries", ["tenant_id"]
    )
    op.create_index(
        "ix_agent_web_search_queries_query_hash", "agent_web_search_queries", ["query_hash"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "query_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("agent_web_search_queries.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_agent_web_search_results_query_id", "agent_web_search_results", ["query_id"]
    )
    ...
    op.create_index(
        "ix_agent_web_search_cache_query_hash",
        "agent_web_search_cache",
        ["query_hash"],
        unique=True,
    )
    ...
    op.create_index(
        "ix_agent_web_search_policy_events_tenant_id",
        "agent_web_search_policy_events",
        ["tenant_id"],
    )
    op.create_index(
        "ix_agent_web_search_policy_events_agent_id", "agent_web_search_policy_events", ["agent_id"]
    )
