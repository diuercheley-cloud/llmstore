...
def upgrade() -> None:
    ...
    op.add_column(
        "billing_plans", sa.Column("rag_max_pages_per_month", sa.Integer(), nullable=True)
    )
    op.add_column(
        "billing_plans", sa.Column("rag_max_queries_per_month", sa.Integer(), nullable=True)
    )
    ...
    op.create_index(
        op.f("ix_client_feature_blocks_client_id"),
        "client_feature_blocks",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_client_feature_blocks_feature"), "client_feature_blocks", ["feature"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_rag_usage_events_client_id"), "rag_usage_events", ["client_id"], unique=False
    )
    op.create_index(
        op.f("ix_rag_usage_events_created_at"), "rag_usage_events", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_rag_usage_events_event_type"), "rag_usage_events", ["event_type"], unique=False
    )
