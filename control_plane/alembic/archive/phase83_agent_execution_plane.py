...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_execution_jobs_agent_id"), "agent_execution_jobs", ["agent_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_execution_jobs_agent_run_id"),
        "agent_execution_jobs",
        ["agent_run_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_execution_jobs_status"), "agent_execution_jobs", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_agent_execution_jobs_tenant_id"),
        "agent_execution_jobs",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_execution_jobs_scheduled_at"),
        "agent_execution_jobs",
        ["scheduled_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_execution_leases_job_id"), "agent_execution_leases", ["job_id"], unique=True
    )
    op.create_index(
        op.f("ix_agent_execution_leases_worker_id"),
        "agent_execution_leases",
        ["worker_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_execution_leases_expires_at"),
        "agent_execution_leases",
        ["expires_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_execution_retries_job_id"),
        "agent_execution_retries",
        ["job_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_execution_dead_letters_job_id"),
        "agent_execution_dead_letters",
        ["job_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_execution_dead_letters_tenant_id"),
        "agent_execution_dead_letters",
        ["tenant_id"],
        unique=False,
    )
