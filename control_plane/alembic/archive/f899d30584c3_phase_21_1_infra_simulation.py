...
def upgrade():
    ...
    op.create_index(
        op.f("ix_commercial_infra_simulations_simulation_type"),
        "commercial_infra_simulations",
        ["simulation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_infra_simulations_target_scope"),
        "commercial_infra_simulations",
        ["target_scope"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_infra_simulations_target_identifier"),
        "commercial_infra_simulations",
        ["target_identifier"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_infra_simulations_blast_radius"),
        "commercial_infra_simulations",
        ["blast_radius"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_infra_simulations_safety_gate_status"),
        "commercial_infra_simulations",
        ["safety_gate_status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_commercial_safety_policies_policy_name"),
        "commercial_safety_policies",
        ["policy_name"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_commercial_approval_records_simulation_id"),
        "commercial_approval_records",
        ["simulation_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_approval_records_status"),
        "commercial_approval_records",
        ["status"],
        unique=False,
    )
