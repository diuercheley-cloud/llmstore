...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_certificate_inventory_subject"), "certificate_inventory", ["subject"], unique=False
    )
    op.create_index(
        op.f("ix_certificate_inventory_issuer"), "certificate_inventory", ["issuer"], unique=False
    )
    op.create_index(
        op.f("ix_certificate_inventory_serial_number"),
        "certificate_inventory",
        ["serial_number"],
        unique=True,
    )
    op.create_index(
        op.f("ix_certificate_inventory_valid_until"),
        "certificate_inventory",
        ["valid_until"],
        unique=False,
    )
    op.create_index(
        op.f("ix_certificate_inventory_is_revoked"),
        "certificate_inventory",
        ["is_revoked"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_attestation_reports_client_id"), "attestation_reports", ["client_id"], unique=False
    )
    op.create_index(
        op.f("ix_attestation_reports_timestamp"), "attestation_reports", ["timestamp"], unique=False
    )
    op.create_index(
        op.f("ix_attestation_reports_policy_result"),
        "attestation_reports",
        ["policy_result"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_plugin_registry_is_active"), "plugin_registry", ["is_active"], unique=False
    )
