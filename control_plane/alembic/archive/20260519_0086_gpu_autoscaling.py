...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_gpu_devices_runtime_node_id"), "gpu_devices", ["runtime_node_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_gpu_allocations_gpu_device_id"), "gpu_allocations", ["gpu_device_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_gpu_capacity_snapshots_runtime_node_id"),
        "gpu_capacity_snapshots",
        ["runtime_node_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_autoscaling_policies_model_registry_id"),
        "autoscaling_policies",
        ["model_registry_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["policy_id"],
            ["autoscaling_policies.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_autoscaling_events_policy_id"), "autoscaling_events", ["policy_id"], unique=False
    )
