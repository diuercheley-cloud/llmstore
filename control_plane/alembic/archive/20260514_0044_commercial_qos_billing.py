...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chargeback_id"],
            ["commercial_queue_chargebacks.id"],
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_commercial_qos_billing_records_client_id"),
        "commercial_qos_billing_records",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_qos_billing_records_qos_tier"),
        "commercial_qos_billing_records",
        ["qos_tier"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_qos_billing_records_model"),
        "commercial_qos_billing_records",
        ["model"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_qos_billing_records_period_start"),
        "commercial_qos_billing_records",
        ["period_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_qos_billing_records_period_end"),
        "commercial_qos_billing_records",
        ["period_end"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_qos_billing_records_status"),
        "commercial_qos_billing_records",
        ["status"],
        unique=False,
    )
