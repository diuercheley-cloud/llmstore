...
down_revision: str | None = "20260522_0093"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_connector_oauth_clients_tenant_id"),
        "connector_oauth_clients",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_connector_oauth_clients_connector_name"),
        "connector_oauth_clients",
        ["connector_name"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_connector_oauth_tokens_tenant_id"),
        "connector_oauth_tokens",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_connector_credential_grants_tenant_id"),
        "connector_credential_grants",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_connector_credential_grants_connector_name"),
        "connector_credential_grants",
        ["connector_name"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_connector_scope_policies_tenant_id"),
        "connector_scope_policies",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_connector_scope_policies_connector_name"),
        "connector_scope_policies",
        ["connector_name"],
        unique=False,
    )
