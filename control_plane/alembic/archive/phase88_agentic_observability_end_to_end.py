...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_incident_links_incident_id"),
        "agent_incident_links",
        ["incident_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_incident_links_linked_incident_id"),
        "agent_incident_links",
        ["linked_incident_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_slo_windows_agent_id"), "agent_slo_windows", ["agent_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_trace_links_run_id"), "agent_trace_links", ["run_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_trace_links_trace_id"), "agent_trace_links", ["trace_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_trace_links_linked_trace_id"),
        "agent_trace_links",
        ["linked_trace_id"],
        unique=False,
    )
