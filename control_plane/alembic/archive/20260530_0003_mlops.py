...
down_revision: str | None = (
    "20260530_0001"  # Wait, is it 20260530_0002? Let's check: Yes, 20260530_0002.
)
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_ml_training_jobs_dataset_version_id", "ml_training_jobs", ["dataset_version_id"]
    )
    ...
    op.create_index(
        "ix_ml_experiment_runs_training_job_id", "ml_experiment_runs", ["training_job_id"]
    )
    ...
    op.create_index(
        "ix_ml_model_lineage_dataset_version_id", "ml_model_lineage", ["dataset_version_id"]
    )
    op.create_index("ix_ml_model_lineage_training_job_id", "ml_model_lineage", ["training_job_id"])
    op.create_index(
        "ix_ml_model_lineage_experiment_run_id", "ml_model_lineage", ["experiment_run_id"]
    )
