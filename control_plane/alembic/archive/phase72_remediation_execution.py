...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_remediation_executions_client_id", "remediation_executions", ["client_id"], unique=False
    )
    op.create_index(
        "ix_remediation_executions_plan_id", "remediation_executions", ["plan_id"], unique=False
    )
    op.create_index(
        "ix_remediation_executions_status", "remediation_executions", ["status"], unique=False
    )
    op.create_index(
        "ix_remediation_executions_immutable_hash",
        "remediation_executions",
        ["immutable_hash"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "execution_status", sa.String(length=50), nullable=False, server_default="pending"
        ),
        sa.Column("dry_run", sa.Boolean(), nullable=False, server_default="1"),
    ...
    op.create_index(
        "ix_remediation_execution_steps_client_id",
        "remediation_execution_steps",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        "ix_remediation_execution_steps_execution_id",
        "remediation_execution_steps",
        ["execution_id"],
        unique=False,
    )
    op.create_index(
        "ix_remediation_execution_steps_immutable_hash",
        "remediation_execution_steps",
        ["immutable_hash"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_remediation_rollback_plans_client_id",
        "remediation_rollback_plans",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        "ix_remediation_rollback_plans_plan_id",
        "remediation_rollback_plans",
        ["plan_id"],
        unique=False,
    )
    op.create_index(
        "ix_remediation_rollback_plans_execution_id",
        "remediation_rollback_plans",
        ["execution_id"],
        unique=False,
    )
    op.create_index(
        "ix_remediation_rollback_plans_immutable_hash",
        "remediation_rollback_plans",
        ["immutable_hash"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_remediation_execution_receipts_client_id",
        "remediation_execution_receipts",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        "ix_remediation_execution_receipts_execution_id",
        "remediation_execution_receipts",
        ["execution_id"],
        unique=False,
    )
    op.create_index(
        "ix_remediation_execution_receipts_immutable_hash",
        "remediation_execution_receipts",
        ["immutable_hash"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_remediation_kill_switch_states_client_id",
        "remediation_kill_switch_states",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        "ix_remediation_kill_switch_states_immutable_hash",
        "remediation_kill_switch_states",
        ["immutable_hash"],
        unique=False,
    )
