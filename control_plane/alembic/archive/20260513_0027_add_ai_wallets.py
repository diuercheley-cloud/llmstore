...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_ai_wallet_transactions_client_id"),
        "ai_wallet_transactions",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ai_wallet_transactions_type"), "ai_wallet_transactions", ["type"], unique=False
    )
    op.create_index(
        op.f("ix_ai_wallet_transactions_created_at"),
        "ai_wallet_transactions",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ai_wallet_transactions_wallet_id"),
        "ai_wallet_transactions",
        ["wallet_id"],
        unique=False,
    )
