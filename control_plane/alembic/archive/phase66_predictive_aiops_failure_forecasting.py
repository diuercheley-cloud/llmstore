...
def upgrade() -> None:
    ...
    op.create_table(
        "commercial_failure_predictions",
    ...
    op.create_index(
        op.f("ix_commercial_failure_predictions_client_id"),
        "commercial_failure_predictions",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_failure_predictions_target_id"),
        "commercial_failure_predictions",
        ["target_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_commercial_anomaly_signals_client_id"),
        "commercial_anomaly_signals",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_anomaly_signals_source_id"),
        "commercial_anomaly_signals",
        ["source_id"],
        unique=False,
    )
    ...
    op.create_table(
        "commercial_node_health_forecasts",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_commercial_node_health_forecasts_node_id"),
        "commercial_node_health_forecasts",
        ["node_id"],
        unique=False,
    )
    ...
    op.create_table(
        "commercial_runtime_risk_trends",
        sa.Column("id", sa.String(), nullable=False),
        sa.Column("client_id", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_commercial_runtime_risk_trends_client_id"),
        "commercial_runtime_risk_trends",
        ["client_id"],
        unique=False,
    )
    ...
    op.create_table(
        "commercial_aiops_recommendations",
        sa.Column("id", sa.String(), nullable=False),
        sa.Column("client_id", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_commercial_aiops_recommendations_client_id"),
        "commercial_aiops_recommendations",
        ["client_id"],
        unique=False,
    )
