...
down_revision: str | None = "phase90_agent_supply_chain"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_workflows_tenant_id"), "agent_workflows", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_workflow_runs_workflow_id"),
        "agent_workflow_runs",
        ["workflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_workflow_runs_tenant_id"), "agent_workflow_runs", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_workflow_runs_status"), "agent_workflow_runs", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_agent_workflow_runs_next_execution_at"),
        "agent_workflow_runs",
        ["next_execution_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_workflow_events_run_id"), "agent_workflow_events", ["run_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_workflow_timers_run_id"), "agent_workflow_timers", ["run_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_workflow_timers_fire_at"), "agent_workflow_timers", ["fire_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_workflow_signals_run_id"), "agent_workflow_signals", ["run_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_workflow_webhook_waits_run_id"),
        "agent_workflow_webhook_waits",
        ["run_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_workflow_webhook_waits_webhook_id"),
        "agent_workflow_webhook_waits",
        ["webhook_id"],
        unique=False,
    )
