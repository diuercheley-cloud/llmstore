...
def upgrade():
    ...
    op.create_index(
        op.f("ix_commercial_revenue_forecasts_forecast_type"),
        "commercial_revenue_forecasts",
        ["forecast_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_revenue_forecasts_client_id"),
        "commercial_revenue_forecasts",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_revenue_forecasts_qos_tier"),
        "commercial_revenue_forecasts",
        ["qos_tier"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_revenue_forecasts_provider"),
        "commercial_revenue_forecasts",
        ["provider"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_revenue_forecasts_model"),
        "commercial_revenue_forecasts",
        ["model"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_revenue_forecasts_period_start"),
        "commercial_revenue_forecasts",
        ["period_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_revenue_forecasts_period_end"),
        "commercial_revenue_forecasts",
        ["period_end"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_commercial_financial_anomalies_anomaly_type"),
        "commercial_financial_anomalies",
        ["anomaly_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_financial_anomalies_severity"),
        "commercial_financial_anomalies",
        ["severity"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_financial_anomalies_client_id"),
        "commercial_financial_anomalies",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_financial_anomalies_detected_at"),
        "commercial_financial_anomalies",
        ["detected_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_financial_anomalies_status"),
        "commercial_financial_anomalies",
        ["status"],
        unique=False,
    )
