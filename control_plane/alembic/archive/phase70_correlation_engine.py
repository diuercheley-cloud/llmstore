...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_operational_correlations_client_id",
        "operational_correlations",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        "ix_operational_correlations_correlation_type",
        "operational_correlations",
        ["correlation_type"],
        unique=False,
    )
    op.create_index(
        "ix_operational_correlations_correlation_key",
        "operational_correlations",
        ["correlation_key"],
        unique=False,
    )
    op.create_index(
        "ix_operational_correlations_immutable_hash",
        "operational_correlations",
        ["immutable_hash"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["correlation_id"], ["operational_correlations.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("immutable_hash"),
    )
    op.create_index(
        "ix_correlated_operational_events_client_id",
        "correlated_operational_events",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        "ix_correlated_operational_events_correlation_id",
        "correlated_operational_events",
        ["correlation_id"],
        unique=False,
    )
    op.create_index(
        "ix_correlated_operational_events_event_type",
        "correlated_operational_events",
        ["event_type"],
        unique=False,
    )
    op.create_index(
        "ix_correlated_operational_events_source_domain",
        "correlated_operational_events",
        ["source_domain"],
        unique=False,
    )
    op.create_index(
        "ix_correlated_operational_events_immutable_hash",
        "correlated_operational_events",
        ["immutable_hash"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_operational_trust_links_client_id",
        "operational_trust_links",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        "ix_operational_trust_links_source_node",
        "operational_trust_links",
        ["source_node"],
        unique=False,
    )
    op.create_index(
        "ix_operational_trust_links_target_node",
        "operational_trust_links",
        ["target_node"],
        unique=False,
    )
    op.create_index(
        "ix_operational_trust_links_immutable_hash",
        "operational_trust_links",
        ["immutable_hash"],
        unique=False,
    )
