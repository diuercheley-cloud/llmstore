...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_eval_failures_agent_id"), "agent_eval_failures", ["agent_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_eval_failures_run_id"), "agent_eval_failures", ["run_id"], unique=False
    )
