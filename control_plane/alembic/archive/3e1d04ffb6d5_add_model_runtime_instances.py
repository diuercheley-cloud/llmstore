...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_model_runtime_instances_backend_id"),
        "model_runtime_instances",
        ["backend_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_model_runtime_instances_is_active"),
        "model_runtime_instances",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_model_runtime_instances_model_id"),
        "model_runtime_instances",
        ["model_id"],
        unique=False,
    )
