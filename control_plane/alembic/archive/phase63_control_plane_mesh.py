...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_commercial_mesh_nodes_name"), "commercial_mesh_nodes", ["name"], unique=True
    )
    op.create_index(
        op.f("ix_commercial_mesh_nodes_region"), "commercial_mesh_nodes", ["region"], unique=False
    )

    # CommercialMeshConsensusEvent
    op.create_table(
        "commercial_mesh_consensus_events",
        sa.Column("id", sa.String(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["proposer_node_id"],
            ["commercial_mesh_nodes.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_commercial_mesh_consensus_events_term"),
        "commercial_mesh_consensus_events",
        ["term"],
        unique=False,
    )
    ...
    op.create_table(
        "commercial_mesh_replication_logs",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_commercial_mesh_replication_logs_log_index"),
        "commercial_mesh_replication_logs",
        ["log_index"],
        unique=False,
    )
    ...
    op.create_table(
        "commercial_mesh_partition_events",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_commercial_mesh_partition_events_partition_id"),
        "commercial_mesh_partition_events",
        ["partition_id"],
        unique=False,
    )
