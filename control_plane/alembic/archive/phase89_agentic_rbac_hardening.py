...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_environment_policies_tenant_id"),
        "agent_environment_policies",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_environment_policies_environment"),
        "agent_environment_policies",
        ["environment"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_ephemeral_credentials_run_id"),
        "agent_ephemeral_credentials",
        ["run_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_rbac_events_admin_user_id"),
        "agent_rbac_events",
        ["admin_user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_policy_exceptions_agent_id"),
        "agent_policy_exceptions",
        ["agent_id"],
        unique=False,
    )
