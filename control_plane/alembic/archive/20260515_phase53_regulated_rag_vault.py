...
def upgrade():
    ...
    op.create_index(
        op.f("ix_commercial_rag_vaults_tenant_id"),
        "commercial_rag_vaults",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["vault_id"],
            ["commercial_rag_vaults.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_commercial_rag_documents_document_hash"),
        "commercial_rag_documents",
        ["document_hash"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["commercial_rag_documents.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_commercial_rag_chunks_chunk_hash"),
        "commercial_rag_chunks",
        ["chunk_hash"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_commercial_retrieval_receipts_receipt_hash"),
        "commercial_retrieval_receipts",
        ["receipt_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_retrieval_receipts_session_id"),
        "commercial_retrieval_receipts",
        ["session_id"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_commercial_retrieval_receipts_session_id"),
        table_name="commercial_retrieval_receipts",
    )
    op.drop_index(
        op.f("ix_commercial_retrieval_receipts_receipt_hash"),
        table_name="commercial_retrieval_receipts",
    ...
    op.drop_index(
        op.f("ix_commercial_rag_documents_document_hash"), table_name="commercial_rag_documents"
    )
