...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_eval_suites_agent_id"), "agent_eval_suites", ["agent_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_eval_cases_suite_id"), "agent_eval_cases", ["suite_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_eval_runs_suite_id"), "agent_eval_runs", ["suite_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_eval_results_case_id"), "agent_eval_results", ["case_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_eval_results_run_id"), "agent_eval_results", ["run_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_eval_baselines_agent_id"), "agent_eval_baselines", ["agent_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_agent_eval_datasets_agent_id"), "agent_eval_datasets", ["agent_id"], unique=False
    )

    # 7. agent_eval_dataset_versions
    op.create_table(
        "agent_eval_dataset_versions",
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_index(
        op.f("ix_agent_eval_dataset_versions_dataset_id"),
        "agent_eval_dataset_versions",
        ["dataset_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_eval_gate_results_agent_id"),
        "agent_eval_gate_results",
        ["agent_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_eval_gate_results_eval_run_id"),
        "agent_eval_gate_results",
        ["eval_run_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_eval_regression_results_agent_id"),
        "agent_eval_regression_results",
        ["agent_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_eval_regression_results_eval_run_id"),
        "agent_eval_regression_results",
        ["eval_run_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_eval_regression_results_baseline_run_id"),
        "agent_eval_regression_results",
        ["baseline_run_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["gate_result_id"], ["agent_eval_gate_results.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["regression_result_id"], ["agent_eval_regression_results.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_agent_promotion_gate_results_agent_id"),
        "agent_promotion_gate_results",
        ["agent_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_prompt_baselines_agent_id"),
        "agent_prompt_baselines",
        ["agent_id"],
        unique=False,
    )
