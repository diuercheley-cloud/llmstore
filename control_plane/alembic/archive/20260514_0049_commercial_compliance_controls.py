...
def upgrade():
    ...
    op.create_index(
        op.f("ix_commercial_control_policies_action_type"),
        "commercial_control_policies",
        ["action_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_policies_control_area"),
        "commercial_control_policies",
        ["control_area"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_policies_enabled"),
        "commercial_control_policies",
        ["enabled"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_commercial_evidence_packages_created_at"),
        "commercial_evidence_packages",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_evidence_packages_immutable_hash"),
        "commercial_evidence_packages",
        ["immutable_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_evidence_packages_package_type"),
        "commercial_evidence_packages",
        ["package_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_evidence_packages_target_id"),
        "commercial_evidence_packages",
        ["target_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_evidence_packages_target_type"),
        "commercial_evidence_packages",
        ["target_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["control_policy_id"], ["commercial_control_policies.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_commercial_approval_chains_control_policy_id"),
        "commercial_approval_chains",
        ["control_policy_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_approval_chains_evidence_package_id"),
        "commercial_approval_chains",
        ["evidence_package_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_approval_chains_requested_by"),
        "commercial_approval_chains",
        ["requested_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_approval_chains_status"),
        "commercial_approval_chains",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_approval_chains_target_id"),
        "commercial_approval_chains",
        ["target_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_approval_chains_target_type"),
        "commercial_approval_chains",
        ["target_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_commercial_control_attestations_attestation_period_end"),
        "commercial_control_attestations",
        ["attestation_period_end"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_attestations_attestation_period_start"),
        "commercial_control_attestations",
        ["attestation_period_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_attestations_control_policy_id"),
        "commercial_control_attestations",
        ["control_policy_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_attestations_evidence_package_id"),
        "commercial_control_attestations",
        ["evidence_package_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_attestations_status"),
        "commercial_control_attestations",
        ["status"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["control_policy_id"], ["commercial_control_policies.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_commercial_control_exceptions_control_policy_id"),
        "commercial_control_exceptions",
        ["control_policy_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_exceptions_exception_type"),
        "commercial_control_exceptions",
        ["exception_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_exceptions_severity"),
        "commercial_control_exceptions",
        ["severity"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commercial_control_exceptions_status"),
        "commercial_control_exceptions",
        ["status"],
        unique=False,
    )
