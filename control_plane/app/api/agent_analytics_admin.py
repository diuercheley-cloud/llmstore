...
def _get_time_range(
    start_time: datetime | None, end_time: datetime | None, days: int
...
async def get_overview(
    ...
    data = await AgentAnalyticsService.get_overview(
        db=db, tenant_id=tenant_id, start_time=start_dt, end_time=end_dt
    )
    return data
...
async def get_agent_metrics(
    ...
    data = await AgentAnalyticsService.get_agent_metrics(
        db=db, tenant_id=tenant_id, agent_id=agent_id, start_time=start_dt, end_time=end_dt
    )
    return data
