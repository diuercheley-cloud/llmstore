...
async def invoke_agent(
    ...
    return await api.invoke_agent(
        agent_id, current_user.tenant_id, input_text, mode="async", tier_name=tier
    )
...
async def invoke_agent_sync(
    ...
    api = AgentServiceAPI(db)
    return await api.invoke_agent(
        agent_id, current_user.tenant_id, input_text, mode="sync", tier_name=tier
    )
