...
class SovereignFederationEnvironment(Base):
    ...
    trust_level: Mapped[str] = mapped_column(
        String(32), nullable=False, default="restricted", index=True
    )
    ...
    environment_hash: Mapped[str] = mapped_column(
...
class FederationSynchronizationSession(Base):
    ...
    source_environment_id: Mapped[str] = mapped_column(
        String(64),
        ForeignKey("sovereign_federation_environments.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
    target_environment_id: Mapped[str] = mapped_column(
        String(64),
        ForeignKey("sovereign_federation_environments.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
...
class FederationSynchronizationBundle(Base):
    ...
    session_id: Mapped[str] = mapped_column(
        String(64),
        ForeignKey("federation_synchronization_sessions.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
    ...
    parent_bundle_hash: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    replay_hash: Mapped[str] = mapped_column(String(64), nullable=False, index=True)
    bundle_status: Mapped[str] = mapped_column(
...
class FederationTrustNegotiation(Base):
    ...
    replay_verification_required: Mapped[bool] = mapped_column(
        Boolean(), nullable=False, default=True
    )
    offline_verification_required: Mapped[bool] = mapped_column(
        Boolean(), nullable=False, default=True
    )
    immutable_hash: Mapped[str] = mapped_column(String(64), nullable=False, index=True, unique=True)
    created_at: Mapped[datetime] = mapped_column(
...
class FederationLineageLink(Base):
    ...
    bundle_id: Mapped[str] = mapped_column(
        String(64),
        ForeignKey("federation_synchronization_bundles.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
    parent_bundle_hash: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
