...
class SovereignExecutionAttestation(Base):
    ...
    previous_attestation_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
...
class AttestationTrustPolicy(Base):
    ...
    require_replay_verification: Mapped[bool] = mapped_column(
...
class AttestationVerificationResult(Base):
    ...
    attestation_id: Mapped[str] = mapped_column(
        String(64),
        ForeignKey("sovereign_execution_attestations.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
...
class AttestationChainLink(Base):
    ...
    previous_link_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
    current_link_hash: Mapped[str] = mapped_column(
