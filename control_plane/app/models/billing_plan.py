...
class BillingPlan(Base):
    ...
    export_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    support_level: Mapped[str] = mapped_column(String(64), default="Community", nullable=False)
