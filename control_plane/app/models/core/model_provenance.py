...
class ModelProvenanceRecord(Base):
    ...
    tokenizer_hash: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    config_hash: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    signature_status: Mapped[str] = mapped_column(String(32), default="unknown")  # verified|unverified|failed|unknown
