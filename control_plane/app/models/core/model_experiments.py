...
class ModelExperiment(Base):
    ...
    )  # draft|running|completed|rolled_back|promoted
    ...
    variants = relationship(
        "ModelExperimentVariant", back_populates="experiment", cascade="all, delete-orphan"
    )
    assignments = relationship(
        "ModelExperimentAssignment", back_populates="experiment", cascade="all, delete-orphan"
    )
    metrics = relationship(
        "ModelExperimentMetric", back_populates="experiment", cascade="all, delete-orphan"
    )
...
class ModelExperimentAssignment(Base):
    ...
    variant_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("model_experiment_variants.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
...
class ModelExperimentMetric(Base):
    ...
    )  # latency, cost, error_rate, eval_score
