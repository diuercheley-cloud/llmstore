...
class ResponseCache(Base):
    ...
    __table_args__ = (
        UniqueConstraint("client_id", "cache_type", "endpoint_type", "model", "request_hash", name="uq_response_cache_lookup"),
    )
    ...
    normalized_prompt_hash: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
