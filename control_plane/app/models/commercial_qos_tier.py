...
class CommercialQoSTier(Base):
    ...
    priority: Mapped[int] = mapped_column(Integer, default=0) # Lower is higher priority? Let's follow Enterprise > Premium > ...
    ...
    degradation_policy: Mapped[str] = mapped_column(String(32), default="best_effort") # block|fallback_local|cheapest|best_effort
