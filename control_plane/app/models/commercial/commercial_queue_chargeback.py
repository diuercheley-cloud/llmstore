...
class CommercialQueueChargeback(Base):
    ...
    estimated_opportunity_cost_brl: Mapped[float] = mapped_column(
        Numeric(18, 6), default=0.0, nullable=False
    )
    estimated_internal_cost_brl: Mapped[float] = mapped_column(
        Numeric(18, 6), default=0.0, nullable=False
    )
    chargeback_amount_brl: Mapped[float] = mapped_column(
        Numeric(18, 6), default=0.0, nullable=False
    )
