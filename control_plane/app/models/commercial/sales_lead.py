...
class SalesLead(Base):
    ...
    timeline_notes: Mapped[list["SalesLeadNote"]] = relationship(
        "SalesLeadNote",
        back_populates="lead",
        cascade="all, delete-orphan",
        order_by="SalesLeadNote.created_at.desc()",
    )
...
class SalesLeadNote(Base):
    ...
    lead_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True), ForeignKey("sales_leads.id"), nullable=False, index=True
    )
