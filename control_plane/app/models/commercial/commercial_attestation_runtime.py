...
class CommercialRuntimeAttestation(Base):
    ...
    attestation_mode: Mapped[str] = mapped_column(
        String(32), default="software_attested", nullable=False, index=True
    )
    enclave_type: Mapped[str] = mapped_column(
        String(32), default="software_attested", nullable=False
    )
...
class CommercialAttestationEvidence(Base):
    ...
    evidence_type: Mapped[str] = mapped_column(
        String(32), default="runtime_measurement", nullable=False, index=True
    )
    evidence_hash: Mapped[str] = mapped_column(String(128), nullable=False, index=True)
...
class CommercialAttestationPolicy(Base):
    ...
    require_for_sensitive_tenants: Mapped[bool] = mapped_column(
...
class CommercialRuntimeMeasurement(Base):
    ...
    measurement_type: Mapped[str] = mapped_column(
        String(32), default="runtime_binary", nullable=False, index=True
    )
...
class CommercialAttestationChallenge(Base):
    ...
    challenge_type: Mapped[str] = mapped_column(
        String(32), default="runtime_measurement", nullable=False
    )
