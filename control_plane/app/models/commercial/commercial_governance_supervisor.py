...
class CommercialGovernanceSupervisorDecision(Base):
    ...
    incident_id: Mapped[uuid.UUID | None] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("commercial_governance_supervisor_incidents.id", ondelete="CASCADE"),
        nullable=True,
        index=True,
    )
    policy_id: Mapped[uuid.UUID | None] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("commercial_governance_supervisor_policies.id", ondelete="SET NULL"),
        nullable=True,
    )
...
class CommercialGovernanceSupervisorAction(Base):
    ...
    decision_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("commercial_governance_supervisor_decisions.id", ondelete="CASCADE"),
        index=True,
    )
