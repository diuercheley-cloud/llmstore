...
class CommercialClusterRegistry(Base):
    ...
    forwarding_enabled: Mapped[bool] = mapped_column(
    ...
    forwarding_require_mtls: Mapped[bool] = mapped_column(
        server_default="false", default=False, nullable=False
    )
    forwarding_status: Mapped[str] = mapped_column(
        String(32), server_default="healthy", default="healthy", nullable=False
    )
