...
from sqlalchemy import DateTime, ForeignKey, Numeric, String, Text, Float, JSON
...
class CommercialFinancialAnomaly(Base):
    ...
    observed_value_brl: Mapped[Decimal] = mapped_column(Numeric(18, 6), default=Decimal("0.000000"), nullable=False)
    expected_value_brl: Mapped[Decimal] = mapped_column(Numeric(18, 6), default=Decimal("0.000000"), nullable=False)
