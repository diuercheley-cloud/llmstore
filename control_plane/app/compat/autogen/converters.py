...
from app.models.agents.agent_sessions import AgentSession, AgentConversationThread, AgentThreadMessage
...
async def convert_autogen_chat_to_session(
    ...
    session = AgentSession(
        ...
        agent_id=agent_id,
        status="active",
        session_metadata={"source": "autogen", "agent_name": agent.name, "recipient_name": recipient_name}
    )
    db.add(session)
