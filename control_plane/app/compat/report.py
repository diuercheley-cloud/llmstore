    ...
    def analyze_source_code(framework: str, source_code: str) -> CompatibilityReport:
        ...
        if framework == "langgraph":
            ...
            if has_conditional_edges:
                ...
                remediations.append("Map conditional edge branches explicitly to separate agent workflow edges in the console.")
            else:
                features.append({
                    "feature": "Conditional Edges",
                    "status": "supported",
            ...
            if has_checkpointer:
                ...
                remediations.append("Replace external Checkpointers with native platform Session / Run state management.")
            else:
                features.append({
                    "feature": "Checkpointer / Persistent Memory",
                    "status": "supported",
            ...
            if has_hierarchical:
                ...
                remediations.append("Convert hierarchical Crew structures into multi-agent teams with explicit delegation rules.")
            else:
                features.append({
            ...
            if has_memory:
                ...
                remediations.append("Integrate database memory policies in the AgentRegistry instead of CrewAI memory options.")
            else:
                features.append({
            ...
            if has_group_chat:
                ...
                remediations.append("Convert GroupChat to native AgentTeam definition with defined members and team runs.")
            else:
                features.append({
                    "feature": "GroupChat",
                    "status": "supported",
            ...
            if has_code_execution:
                ...
                remediations.append("Use the platform's native ToolSandbox service for running generated code safely.")
            else:
                features.append({
            ...
            remediations.append(f"Ensure target framework is 'langgraph', 'crewai', or 'autogen'.")
