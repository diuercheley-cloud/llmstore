...
def include_optional_routers(app: FastAPI, settings) -> None:
    ...
    if _flag("agent_debugger_enabled"):
        ...
        app.include_router(
            agent_debugger_admin_router, prefix="/api/v1/admin/debugger", tags=["agent-debugger"]
        )

    from app.api.prompt_admin import router as prompt_admin_router

    app.include_router(
        prompt_admin_router, prefix="/api/v1/admin/prompts", tags=["prompt-management"]
    )

    from app.api.agent_analytics_admin import router as agent_analytics_admin_router

    app.include_router(
        agent_analytics_admin_router,
        prefix="/api/v1/admin/agents/analytics",
    ...
    app.include_router(
        agent_service_router, prefix="/api/v1/agent-service", tags=["agent-as-a-service"]
    )
    ...
    if _flag("managed_control_plane_enabled") and getattr(settings, "deployment_mode", None) in (
        "enterprise_managed",
    ...
    if getattr(settings, "commercial_qos_enabled", True):
        ...
        app.include_router(
            commercial_qos_billing_admin_router,
            prefix="/admin/billing/qos",
            tags=["commercial_qos_billing"],
        )
    ...
    if getattr(settings, "commercial_revenue_protection_enabled", True):
        ...
        app.include_router(
            commercial_revenue_protection_admin_router, tags=["commercial_revenue_protection"]
        )
    ...
    if getattr(settings, "commercial_revenue_escalations_enabled", True):
        ...
        app.include_router(
            commercial_revenue_escalations_admin_router, tags=["commercial_revenue_escalation"]
        )
    ...
    if getattr(settings, "commercial_global_routing_enabled", True):
        ...
        app.include_router(
            commercial_global_routing_admin_router,
            prefix="/admin/routing/global-router",
            tags=["commercial_global_routing"],
        )
        app.include_router(
            commercial_global_traffic_admin_router,
            prefix="/admin/routing/global-traffic",
            tags=["commercial_global_traffic"],
        )
    ...
    if getattr(settings, "commercial_cross_cluster_forwarding_enabled", True):
        ...
        app.include_router(
            commercial_cross_cluster_forwarding_admin_router,
            prefix="/admin/routing/cross-cluster-forwarding",
            tags=["commercial_cross_cluster_forwarding"],
        )
    ...
    if getattr(settings, "commercial_geo_routing_enabled", True):
        ...
        app.include_router(
            commercial_geo_routing_admin_router,
            prefix="/admin/routing/geo-routing",
            tags=["commercial_geo_routing"],
        )
    ...
    if getattr(settings, "commercial_live_balancing_enabled", True):
        ...
        app.include_router(
            commercial_live_balancing_admin_router,
            prefix="/admin/routing/live-balancing",
            tags=["commercial_live_balancing"],
        )
    ...
    app.include_router(
        tool_synthesis_admin_router,
        prefix="/admin/agents/tool-synthesis",
        tags=["agent_tool_synthesis"],
    )
    app.include_router(
        tool_synthesis_sandbox_router, prefix="/admin/agents/sandbox", tags=["agent_sandbox"]
    )
    app.include_router(
        tool_synthesis_public_router,
        prefix="/agents/tools/generated",
        tags=["agent_generated_tools"],
    )
