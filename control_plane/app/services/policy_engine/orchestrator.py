...
class PolicyEngineOrchestrator:
    ...
    async def evaluate(self, context: PolicyContext, preferred_engine: str = "builtin") -> PolicyDecision:
        """
        ...
        try:
            ...
            logger.error(f"Error evaluating policy with {preferred_engine}: {e}. Falling back to builtin.")
