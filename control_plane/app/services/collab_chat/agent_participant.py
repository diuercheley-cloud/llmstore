...
class AgentParticipantService:
    ...
    async def add_agent_to_channel(self, channel_id: uuid.UUID, agent_id: uuid.UUID, auto_reply: bool = False):
    ...
    async def trigger_agent_run(self, channel_id: uuid.UUID, agent_id: uuid.UUID, user_id: str, prompt: str):
