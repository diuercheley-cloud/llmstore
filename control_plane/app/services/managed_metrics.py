...
managed_appliances_total = Gauge(
    "llm_managed_appliances_total", "Total number of managed appliances", ["workspace_id", "status"]
)
...
managed_workspaces_total = Gauge(
    "llm_managed_workspaces_total", "Total number of managed workspaces", ["organization_id"]
)


def update_managed_metrics(
    appliances_count: int, offline_count: int, workspaces_count: int, org_id: str = "default"
):
