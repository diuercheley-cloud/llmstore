...
class AdapterStagingSimulationService:
    ...
    def validate_staging_simulation(self, entry: SignedAdapterRegistryEntry, context: Dict[str, Any]) -> bool:
    ...
    def build_staging_simulation_summary(self, entry: SignedAdapterRegistryEntry, context: Dict[str, Any]) -> Dict[str, Any]:
