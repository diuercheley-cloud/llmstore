...
class RemediationApprovalRequirementService:
    ...
    def determine_required_approvals(self, plan: Dict[str, Any], steps: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
    ...
    def build_approval_requirements(self, plan: Dict[str, Any], steps: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
