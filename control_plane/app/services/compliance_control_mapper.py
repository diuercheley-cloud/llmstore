...
class ComplianceControlMapperService:
    ...
    def list_controls(self, framework: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def validate_control(self, control: Dict[str, Any]):
        ...
        for field in ["title", "description"]:
            ...
            if "PRIVATE KEY" in val or "API_KEY" in val:
                raise ValueError(f"Control {control.get('control_id')} contains sensitive info in {field}")
