...
class RateLimitService:
    ...
    async def check_rate_limit(
        self, tenant_id: str, client_id: str, endpoint: str, limit_per_minute: int
    ) -> RateLimitResult:
...
async def apply_api_rate_limit(
    ...
    res = await svc.check_rate_limit(
        tenant_id=tenant_id, client_id=str(client.id), endpoint=endpoint, limit_per_minute=limit
    )
