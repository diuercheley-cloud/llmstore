...
class CommercialLiveBalancer:
    ...
    def recommend_rebalance(self, source_cluster: str, metrics: dict, history: list[dict], qos_tier: Any | None = None) -> dict[str, Any]:
        ...
        if qos_tier:
            ...
            if latency > qos_tier.max_p95_latency_ms:
                return {
                    ...
                    "target_decrease_percent": self.settings.commercial_live_balancing_max_traffic_change_percent * 1.5 # More aggressive
                }
