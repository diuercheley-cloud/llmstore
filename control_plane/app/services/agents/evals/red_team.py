...
class RedTeamScanner:
    ...
    async def add_case(self, agent_id: uuid.UUID, attack_type: str, payload: str, expected_denial: bool = True) -> AgentRedTeamCase:
    ...
    async def get_cases(self, agent_id: uuid.UUID, attack_type: str = None) -> List[AgentRedTeamCase]:
    ...
    def detect_jailbreak(self, input_text: str) -> bool:
        ...
        jailbreak_keywords = ["DAN", "Developer Mode", "ignore previous instructions", "do anything now"]
        return any(kw.lower() in input_text.lower() for kw in jailbreak_keywords)

    def detect_injection(self, input_text: str) -> bool:
        """Prompt injection detection."""
        injection_keywords = ["system override", "new system message", "END OF MESSAGE", "User: Admin"]
