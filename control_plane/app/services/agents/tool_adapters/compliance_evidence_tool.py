...
class ComplianceEvidenceToolAdapter(ToolAdapterContract):
    ...
    def input_schema(self) -> dict[str, Any]:
        return {
            "type": "object",
            "properties": {"policy_id": {"type": "string"}, "evidence_type": {"type": "string"}},
    ...
    def output_schema(self) -> dict[str, Any]:
        return {
            "type": "object",
            "properties": {"evidence_id": {"type": "string"}, "timestamp": {"type": "string"}},
        }
    ...
    async def execute(self, **kwargs) -> dict[str, Any]:
        return {"evidence_id": "ev-998877", "timestamp": "2026-05-22T10:00:00Z"}

    async def dry_run(self, **kwargs) -> dict[str, Any]:
        return {
            "status": "dry_run",
            "message": f"Would collect evidence for policy {kwargs['policy_id']}",
        }
