...
class ArtifactDiffManager:
    ...
    def compute_diff(content_a: str, content_b: str) -> dict[str, Any]:
        ...
        diff_lines = list(
            difflib.unified_diff(lines_a, lines_b, fromfile="version_a", tofile="version_b")
        )
        ...
        return {"raw_diff": "".join(diff_lines), "structured": structured}

    @staticmethod
    async def get_version_by_number(
        db: AsyncSession, artifact_id: Any, version_number: int
