...
class SandboxService:
    ...
    async def execute_tool_safely(
        self, tool_name: str, command: list[str], requested_level: SandboxLevel = SandboxLevel.NONE
    ) -> SandboxExecutionResult:
        ...
        # 3. Create Request
        request = SandboxExecutionRequest(command=command, policy=policy)
    ...
    def _select_provider(self, required_level: SandboxLevel) -> SandboxProvider | None:
