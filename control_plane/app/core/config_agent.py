...
class AgentSettings(BaseSettings):
    ...
    # Status: beta
    agent_bundle_signature_required: bool = Field(
        default=True, alias="AGENT_BUNDLE_SIGNATURE_REQUIRED"
    )
    agent_internal_bundle_signature_required_in_production: bool = Field(
        default=True, alias="AGENT_INTERNAL_BUNDLE_SIGNATURE_REQUIRED_IN_PRODUCTION"
    )
    allow_unsigned_internal_bundles: bool = Field(
        default=False, alias="ALLOW_UNSIGNED_INTERNAL_BUNDLES"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_cognitive_loopback_enabled: bool = Field(
        default=True, alias="AGENT_COGNITIVE_LOOPBACK_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_fewshot_auto_curator_enabled: bool = Field(
        default=False, alias="AGENT_FEWSHOT_AUTO_CURATOR_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_feedback_learning_enabled: bool = Field(
        default=False, alias="AGENT_FEEDBACK_LEARNING_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_uncertainty_detection_enabled: bool = Field(
        default=True, alias="AGENT_UNCERTAINTY_DETECTION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_uncertainty_auto_research_enabled: bool = Field(
        default=False, alias="AGENT_UNCERTAINTY_AUTO_RESEARCH_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_uncertainty_hitl_enabled: bool = Field(
        default=True, alias="AGENT_UNCERTAINTY_HITL_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_meta_reviewer_blocking_mode: bool = Field(
        default=False, alias="AGENT_META_REVIEWER_BLOCKING_MODE"
    )
    # Owner: agent-platform
    # Status: beta
    agent_meta_reviewer_parallel_enabled: bool = Field(
        default=False, alias="AGENT_META_REVIEWER_PARALLEL_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_visual_flow_editor_enabled: bool = Field(
        default=False, alias="AGENT_VISUAL_FLOW_EDITOR_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_time_travel_debugger_enabled: bool = Field(
        default=False, alias="AGENT_TIME_TRAVEL_DEBUGGER_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_replay_from_step_enabled: bool = Field(
        default=False, alias="AGENT_REPLAY_FROM_STEP_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_debug_state_editing_enabled: bool = Field(
        default=False, alias="AGENT_DEBUG_STATE_EDITING_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_wallet_external_spend_enabled: bool = Field(
        default=False, alias="AGENT_WALLET_EXTERNAL_SPEND_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_physical_actuation_enabled: bool = Field(
        default=False, alias="AGENT_PHYSICAL_ACTUATION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_planner_real_execution_enabled: bool = Field(
        default=False, alias="AGENT_PLANNER_REAL_EXECUTION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_federated_memory_enabled: bool = Field(
        default=False, alias="AGENT_FEDERATED_MEMORY_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_federated_memory_sync_enabled: bool = Field(
        default=False, alias="AGENT_FEDERATED_MEMORY_SYNC_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_federated_memory_raw_data_sync: bool = Field(
        default=False, alias="AGENT_FEDERATED_MEMORY_RAW_DATA_SYNC"
    )
    # Owner: agent-platform
    # Status: experimental
    ...
    # Owner: agent-platform
    # Status: experimental
    agent_mcts_sandbox_simulation_enabled: bool = Field(
        default=False, alias="AGENT_MCTS_SANDBOX_SIMULATION_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_constraint_reasoning_enabled: bool = Field(
        default=False, alias="AGENT_CONSTRAINT_REASONING_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    ...
    # Owner: agent-platform
    # Status: experimental
    agent_optimizer_tournaments_enabled: bool = Field(
        default=False, alias="AGENT_OPTIMIZER_TOURNAMENTS_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_optimizer_parallel_evals_enabled: bool = Field(
        default=False, alias="AGENT_OPTIMIZER_PARALLEL_EVALS_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_optimizer_apply_winner_enabled: bool = Field(
        default=False, alias="AGENT_OPTIMIZER_APPLY_WINNER_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_auto_optimization_enabled: bool = Field(
        default=False, alias="AGENT_AUTO_OPTIMIZATION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_optimization_apply_enabled: bool = Field(
        default=False, alias="AGENT_OPTIMIZATION_APPLY_ENABLED"
    )
    ...
    agent_web_search_external_network_enabled: bool = Field(
        default=False, alias="AGENT_WEB_SEARCH_EXTERNAL_NETWORK_ENABLED"
    )
    agent_web_search_allowlist_enabled: bool = Field(
        default=True, alias="AGENT_WEB_SEARCH_ALLOWLIST_ENABLED"
    )
    ...
    # Owner: agent-platform
    # Status: beta
    agent_cognitive_memory_enabled: bool = Field(
        default=False, alias="AGENT_COGNITIVE_MEMORY_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_long_term_memory_enabled: bool = Field(
        default=False, alias="AGENT_LONG_TERM_MEMORY_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_memory_encryption_enabled: bool = Field(
        default=False, alias="AGENT_MEMORY_ENCRYPTION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_memory_semantic_search_enabled: bool = Field(
        default=False, alias="AGENT_MEMORY_SEMANTIC_SEARCH_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_semantic_memory_enabled: bool = Field(
        default=False, alias="AGENT_SEMANTIC_MEMORY_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_memory_embeddings_provider: str = Field(
        default="mock", alias="AGENT_MEMORY_EMBEDDINGS_PROVIDER"
    )
    # Owner: agent-platform
    # Status: beta
    agent_memory_context_injection_enabled: bool = Field(
        default=False, alias="AGENT_MEMORY_CONTEXT_INJECTION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_saas_connectors_enabled: bool = Field(
        default=False, alias="AGENT_SAAS_CONNECTORS_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_connector_write_enabled: bool = Field(
        default=False, alias="AGENT_CONNECTOR_WRITE_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_connector_external_network_enabled: bool = Field(
        default=False, alias="AGENT_CONNECTOR_EXTERNAL_NETWORK_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_connector_real_http_enabled: bool = Field(
        default=False, alias="AGENT_CONNECTOR_REAL_HTTP_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_github_connector_enabled: bool = Field(
        default=False, alias="AGENT_GITHUB_CONNECTOR_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_embedded_worker_enabled: bool = Field(
        default=False, alias="AGENT_EMBEDDED_WORKER_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_eval_allow_mock_for_promotion: bool = Field(
        default=False, alias="AGENT_EVAL_ALLOW_MOCK_FOR_PROMOTION"
    )
    # Owner: agent-platform
    # Status: beta
    agent_eval_real_provider_enabled: bool = Field(
        default=False, alias="AGENT_EVAL_REAL_PROVIDER_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_production_requires_eval_baseline: bool = Field(
        default=True, alias="AGENT_PRODUCTION_REQUIRES_EVAL_BASELINE"
    )
    # Owner: agent-platform
    # Status: beta
    agent_promotion_requires_evals: bool = Field(
        default=False, alias="AGENT_PROMOTION_REQUIRES_EVALS"
    )
    # Owner: agent-platform
    # Status: beta
    agent_eval_regression_gate_enabled: bool = Field(
        default=True, alias="AGENT_EVAL_REGRESSION_GATE_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_real_provider_validation_enabled: bool = Field(
        default=False, alias="AGENT_REAL_PROVIDER_VALIDATION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_destructive_tools_enabled: bool = Field(
        default=False, alias="AGENT_DESTRUCTIVE_TOOLS_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_async_execution_enabled: bool = Field(
        default=False, alias="AGENT_ASYNC_EXECUTION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_tool_credential_delegation_enabled: bool = Field(
        default=False, alias="AGENT_TOOL_CREDENTIAL_DELEGATION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_execution_plane_enabled: bool = Field(
        default=False, alias="AGENT_EXECUTION_PLANE_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_queue_backpressure_enabled: bool = Field(
        default=False, alias="AGENT_QUEUE_BACKPRESSURE_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_context_compression_enabled: bool = Field(
        default=False, alias="AGENT_CONTEXT_COMPRESSION_ENABLED"
    )
    ...
    agent_executor_allow_simulation: bool = Field(
        default=False, alias="AGENT_EXECUTOR_ALLOW_SIMULATION"
    )
    ...
    # Owner: agent-platform
    # Status: beta
    agent_multi_agent_arbitration_enabled: bool = Field(
        default=False, alias="AGENT_MULTI_AGENT_ARBITRATION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_multi_agent_critic_review_enabled: bool = Field(
        default=False, alias="AGENT_MULTI_AGENT_CRITIC_REVIEW_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_multi_agent_mock_arbitration: bool = Field(
        default=False, alias="AGENT_MULTI_AGENT_MOCK_ARBITRATION"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_pubsub_triggers_enabled: bool = Field(
        default=False, alias="AGENT_PUBSUB_TRIGGERS_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_iam_enabled: bool = Field(default=False, alias="AGENT_IAM_ENABLED")
    ...
    # Owner: agent-platform
    # Status: beta
    agent_stateful_workflows_enabled: bool = Field(
        default=False, alias="AGENT_STATEFUL_WORKFLOWS_ENABLED"
    )
    ...
    # Owner: agent-platform
    # Status: active
    agent_allow_mock_llm_in_production: bool = Field(
        default=False, alias="AGENT_ALLOW_MOCK_LLM_IN_PRODUCTION"
    )
    # Owner: agent-platform
    # Status: active
    agent_require_real_llm_for_production: bool = Field(
        default=True, alias="AGENT_REQUIRE_REAL_LLM_FOR_PRODUCTION"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    agent_distributed_runtime_enabled: bool = Field(
        default=False, alias="AGENT_DISTRIBUTED_RUNTIME_ENABLED"
    )
    multi_cluster_enabled: bool = Field(default=False, alias="MULTI_CLUSTER_ENABLED")
    agent_cluster_federation_enabled: bool = Field(
        default=False, alias="AGENT_CLUSTER_FEDERATION_ENABLED"
    )

    # Owner: agent-platform
    # Status: beta
    agent_remote_marketplace_enabled: bool = Field(
        default=False, alias="AGENT_REMOTE_MARKETPLACE_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Status: beta
    agent_bundle_signature_required: bool = Field(
        default=False, alias="AGENT_BUNDLE_SIGNATURE_REQUIRED"
    )

    # Owner: agent-platform
    # Status: beta
    agent_incident_response_enabled: bool = Field(
        default=True, alias="AGENT_INCIDENT_RESPONSE_ENABLED"
    )

    # Owner: agent-platform
    # Status: active
    agent_telemetry_backpressure_enabled: bool = Field(
        default=True, alias="AGENT_TELEMETRY_BACKPRESSURE_ENABLED"
    )
    # Owner: agent-platform
    # Status: active
    agent_telemetry_drop_debug_spans_enabled: bool = Field(
        default=True, alias="AGENT_TELEMETRY_DROP_DEBUG_SPANS_ENABLED"
    )
    # Owner: agent-platform
    # Status: active
    agent_telemetry_strict_export: bool = Field(
        default=False, alias="AGENT_TELEMETRY_STRICT_EXPORT"
    )
    # Owner: agent-platform
    # Status: production
    ...
    agent_anomaly_detection_enabled: bool = Field(
        default=False, alias="AGENT_ANOMALY_DETECTION_ENABLED"
    )
    ...
    # Owner: agent-platform
    # Status: active
    agent_worker_autoscaling_enabled: bool = Field(
        default=False, alias="AGENT_WORKER_AUTOSCALING_ENABLED"
    )
    # Owner: agent-platform
    # Status: active
    agent_slo_enforcement_enabled: bool = Field(
        default=False, alias="AGENT_SLO_ENFORCEMENT_ENABLED"
    )
    # Owner: agent-platform
    # Status: active
    agent_enterprise_observability_enabled: bool = Field(
        default=False, alias="AGENT_ENTERPRISE_OBSERVABILITY_ENABLED"
    )
    # Owner: agent-platform
    # Status: active
    ...
    # Owner: agent-platform
    # Status: beta
    agent_approval_portal_enabled: bool = Field(
        default=False, alias="AGENT_APPROVAL_PORTAL_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_human_approval_enabled: bool = Field(default=True, alias="AGENT_HUMAN_APPROVAL_ENABLED")
    agent_approval_required_for_high_risk: bool = Field(
        default=True, alias="AGENT_APPROVAL_REQUIRED_FOR_HIGH_RISK"
    )
    agent_approval_timeout_seconds: int = Field(
        default=3600, alias="AGENT_APPROVAL_TIMEOUT_SECONDS"
    )
    ...
    agent_websocket_streaming_enabled: bool = Field(
        default=False, alias="AGENT_WEBSOCKET_STREAMING_ENABLED"
    )

    agent_email_notifications_enabled: bool = Field(
        default=False, alias="AGENT_EMAIL_NOTIFICATIONS_ENABLED"
    )
    agent_push_notifications_enabled: bool = Field(
        default=False, alias="AGENT_PUSH_NOTIFICATIONS_ENABLED"
    )
    ...
    agent_distributed_rate_limiting_enabled: bool = Field(
        default=False, alias="AGENT_DISTRIBUTED_RATE_LIMITING_ENABLED"
    )
    ...
    agent_code_interpreter_enabled: bool = Field(
        default=False, alias="AGENT_CODE_INTERPRETER_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    agent_sandbox_allow_simulated_provider: bool = Field(
        default=False, alias="AGENT_SANDBOX_ALLOW_SIMULATED_PROVIDER"
    )
    # Owner: agent-platform
    # Status: production-ready
    # If True, every sandbox execution must have a valid cryptographical or behavioral attestation.
    agent_sandbox_production_requires_attestation: bool = Field(
        default=False, alias="AGENT_SANDBOX_PRODUCTION_REQUIRES_ATTESTATION"
    )
    # Owner: agent-platform
    # Status: beta
    agent_code_sandbox_docker_enabled: bool = Field(
        default=False, alias="AGENT_CODE_SANDBOX_DOCKER_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_code_sandbox_firecracker_enabled: bool = Field(
        default=False, alias="AGENT_CODE_SANDBOX_FIRECRACKER_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_code_sandbox_gvisor_enabled: bool = Field(
        default=False, alias="AGENT_CODE_SANDBOX_GVISOR_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_code_sandbox_microvm_required: bool = Field(
        default=False, alias="AGENT_CODE_SANDBOX_MICROVM_REQUIRED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_code_sandbox_wasm_enabled: bool = Field(
        default=False, alias="AGENT_CODE_SANDBOX_WASM_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_code_sandbox_network_enabled: bool = Field(
        default=False, alias="AGENT_CODE_SANDBOX_NETWORK_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_code_sandbox_write_enabled: bool = Field(
        default=False, alias="AGENT_CODE_SANDBOX_WRITE_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_dynamic_tool_execution_enabled: bool = Field(
        default=False, alias="AGENT_DYNAMIC_TOOL_EXECUTION_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_mcp_external_network_enabled: bool = Field(
        default=False, alias="AGENT_MCP_EXTERNAL_NETWORK_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: experimental
    agent_mcp_oauth_token_exchange_enabled: bool = Field(
        default=False, alias="AGENT_MCP_OAUTH_TOKEN_EXCHANGE_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_mcp_user_delegation_required: bool = Field(
        default=False, alias="AGENT_MCP_USER_DELEGATION_REQUIRED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_mcp_global_credentials_allowed: bool = Field(
        default=False, alias="AGENT_MCP_GLOBAL_CREDENTIALS_ALLOWED"
    )
    # Owner: agent-platform
    # Status: experimental
    ...
    agent_mcp_real_discovery_enabled: bool = Field(
        default=False, alias="AGENT_MCP_REAL_DISCOVERY_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    ...
    # Owner: agent-platform
    # Status: production-ready
    agent_connector_catalog_enabled: bool = Field(
        default=False, alias="AGENT_CONNECTOR_CATALOG_ENABLED"
    )
    # Owner: agent-platform
    # Status: production-ready
    ...
    # Owner: agent-platform
    # Status: production-ready
    agent_plugin_supply_chain_enabled: bool = Field(
        default=False, alias="AGENT_PLUGIN_SUPPLY_CHAIN_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    agent_knowledge_graph_enabled: bool = Field(
        default=False, alias="AGENT_KNOWLEDGE_GRAPH_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: experimental
    prompt_template_playground_enabled: bool = Field(
        default=False, alias="PROMPT_TEMPLATE_PLAYGROUND_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_graph_external_db_enabled: bool = Field(
        default=False, alias="AGENT_GRAPH_EXTERNAL_DB_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: beta
    agent_kg_external_provider_enabled: bool = Field(
        default=False, alias="AGENT_KG_EXTERNAL_PROVIDER_ENABLED"
    )
    # Owner: agent-platform
    # Status: beta
    ...
    # Owner: agent-platform
    # Status: experimental
    agent_kg_adjacency_cache_enabled: bool = Field(
        default=False, alias="AGENT_KG_ADJACENCY_CACHE_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    agent_kg_postgres_graph_enabled: bool = Field(
        default=True, alias="AGENT_KG_POSTGRES_GRAPH_ENABLED"
    )
    # Owner: agent-platform
    # Status: experimental
    ...
    # Owner: agent-platform
    # Status: experimental
    agent_kg_pathfinding_timeout_ms: int = Field(
        default=5000, alias="AGENT_KG_PATHFINDING_TIMEOUT_MS"
    )
    ...
    agent_browser_external_network_enabled: bool = Field(
        default=False, alias="AGENT_BROWSER_EXTERNAL_NETWORK_ENABLED"
    )
    agent_browser_screenshot_enabled: bool = Field(
        default=False, alias="AGENT_BROWSER_SCREENSHOT_ENABLED"
    )
    agent_browser_allowlist: str = Field(
        default="example.com,wikipedia.org", alias="AGENT_BROWSER_ALLOWLIST"
    )
