...
- CLI and SDK: `scripts/agentctl`, `scripts/agentctl.py`, `sdk/python/`, `sdk/node/`
- IDE integration: `integrations/vscode-extension/`
- Validation: `tests/`, `control_plane/tests/`, `scripts/validate-*.sh`
...
pytest tests/operations/test_federation_replay_verifier.py tests/operations/test_attestation_replay_verifier.py
```
