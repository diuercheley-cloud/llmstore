...
| 2.2 | check-secrets --all limpo | Nenhum segredo real no codigo versionado | `./scripts/check-secrets.sh --all` | Exit code 0 | todo | true |
...
| 3.6 | Chat completion funcional | Endpoint de chat funcional | `./scripts/test-chat.sh` | Exit code 0 | todo | true |
| 3.7 | Streaming SSE funcional | Streaming de resposta funcional | `./scripts/test-stream.sh` | Exit code 0 | todo | true |

## 4. Instalacao

| # | Item | Descricao | Comando | Evidencia | Status | Blocker |
|---|------|-----------|---------|-----------|--------|---------|
| 4.1 | Script de instalacao existe | install-local-appliance.sh presente | `ls scripts/install-local-appliance.sh` | Arquivo existe | todo | true |
...
| 4.3 | Instalador aceita --dry-run | Modo dry-run seguro | `./scripts/install-local-appliance.sh --dry-run` | Exit code 0 | todo | true |
| 4.4 | Wizard de configuracao funcional | configure-local-wizard.sh disponivel | `ls scripts/configure-local-wizard.sh` | Arquivo existe | todo | false |
| 4.5 | Pos-instalacao validada | validate-post-install-local.sh funcional | `ls scripts/validate-post-install-local.sh` | Arquivo existe | todo | false |

## 5. Backup / Restore

| # | Item | Descricao | Comando | Evidencia | Status | Blocker |
|---|------|-----------|---------|-----------|--------|---------|
| 5.1 | Script de backup existe | backup-local.sh presente | `ls scripts/backup-local.sh` | Arquivo existe | todo | true |
| 5.2 | Script de restore existe | restore-local.sh presente | `ls scripts/restore-local.sh` | Arquivo existe | todo | true |
| 5.3 | Backup aceita --dry-run | Modo seguro disponivel | `./scripts/backup-local.sh --dry-run` | Exit code 0 | todo | true |
| 5.4 | Restore aceita --dry-run | Modo seguro disponivel | `./scripts/restore-local.sh --dry-run /tmp/fake` | Exit code 0 | todo | true |
...
| # | Item | Descricao | Comando | Evidencia | Status | Blocker |
|---|------|-----------|---------|-----------|--------|---------|
| 6.1 | Script de upgrade existe | upgrade-local.sh presente | `ls scripts/upgrade-local.sh` | Arquivo existe | todo | true |
| 6.2 | Script de rollback existe | rollback-local.sh presente | `ls scripts/rollback-local.sh` | Arquivo existe | todo | true |
...
| 6.4 | Rollback exige confirmacao | Confirmacao forte antes de rollback | `grep -q "confirmation" scripts/rollback-local.sh` | Confirmacao presente | todo | true |
| 6.5 | Upgrade exige backup previo | Backup obrigatorio antes do upgrade | `grep -q "backup" scripts/upgrade-local.sh` | Backup check presente | todo | true |

## 7. Demo Comercial

| # | Item | Descricao | Comando | Evidencia | Status | Blocker |
|---|------|-----------|---------|-----------|--------|---------|
| 7.1 | Demo pack existe | commercial demo pack seedavel | `ls scripts/seed-commercial-demo-pack.sh` | Arquivo existe | todo | true |
...
| 7.3 | Meeting-ready check funcional | Pre-demo meeting check disponivel | `ls scripts/meeting-ready-check-local.sh` | Arquivo existe | todo | false |
...
| 8.6 | Documentos sem secrets | Nenhum segredo em docs de cliente | `./scripts/check-secrets.sh --path docs/` | Exit code 0 | todo | true |
...
| 9.3 | Gerador de propostas funcional | generate-client-proposal.sh disponivel | `ls scripts/generate-client-proposal.sh` | Arquivo existe | todo | false |
| 9.4 | Gerador de SOW funcional | generate-sow-local.sh disponivel | `ls scripts/generate-sow-local.sh` | Arquivo existe | todo | false |
| 9.5 | White-label configuracao existe | White-label branding disponivel | `ls scripts/validate-white-label-local.sh` | Arquivo existe | todo | false |
...
| 11.6 | Artifacts de release sem secrets | check-secrets nos artifacts de release | `./scripts/check-secrets.sh --path releases/v1.7.0-local-ai-appliance` | Exit code 0 | todo | true |
