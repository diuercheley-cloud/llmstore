...
```bash
./scripts/validators/validate-openai-real-provider.sh --real
./scripts/validators/validate-deepseek-real-provider.sh --real
./scripts/validators/validate-anthropic-real-provider.sh --real
./scripts/validators/validate-real-fallback-local-to-cloud.sh --real
./scripts/dev/measure-real-provider-costs.sh --real
./scripts/validators/validate-real-billing-margin.sh --real
./scripts/validators/validate-real-providers-e2e.sh --real --max-cost-brl 2.00
```
