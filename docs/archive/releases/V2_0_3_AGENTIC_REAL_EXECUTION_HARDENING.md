...
PYTHONPATH=control_plane .venv/bin/pytest -q \
  ...
  tests/integration/runtime/test_real_execution_readiness.py \
  tests/integration/kubernetes/test_operator_reconciler.py \
  tests/integration/agent_tasks/test_task_execution.py
```
