...
- **Security**: No secrets or private certificates found in versioned files (verified via `bash scripts/validators/check-secrets.sh --all`).
...
- Passed: `bash scripts/validators/check-secrets.sh --all`
