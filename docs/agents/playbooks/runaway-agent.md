...
1. **Diagnóstico**: Execute `scripts/agent-incident-diagnose.sh` para confirmar o estado da run.
2. **Mitigação Imediata**: Utilize `scripts/agent-run-kill.sh` para forçar o encerramento da execução.
