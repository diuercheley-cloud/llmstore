...
- `scripts/validators/validate_framework_warnings.py`: Static check for common deprecated patterns.
- `tests/integration/quality/test_framework_warnings.py`: Runtime check for unexpected warnings during critical paths.
