...
def main():
    ...
    api_ok = check_content(
        "control_plane/app/api/operations_remediation_execution_admin.py", api_patterns
    )
    ...
    admin_dashboard_ok = check_content(
        "control_plane/app/static/admin/index.html", dashboard_patterns
    )
    portal_dashboard_ok = check_content(
        "control_plane/app/static/portal/index.html", dashboard_patterns
    )
    ...
    if (
        ...
        and gate_ok
        and forbidden_ok
        and admin_dashboard_ok
        and portal_dashboard_ok
    ):
