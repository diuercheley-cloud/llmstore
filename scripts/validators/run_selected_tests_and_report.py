...
SELECTED_TESTS = [
    ...
    "tests/integration/llm_harness/test_ide_assistant.py::test_context_ref_folder_includes_multiple_files_with_limit",
    "tests/integration/releases/test_profile_resolver.py::test_profile_high_risk_allowed_with_auth",
    "tests/integration/releases/test_profile_resolver.py::test_production_profile_validation_requires_worker",
