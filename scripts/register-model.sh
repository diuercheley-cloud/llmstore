...
MODEL_ID="${1:?usage: ./scripts/register-model.sh MODEL_ID MODEL_FILE [MODEL_ALIAS] [PROVIDER] [CONTEXT_LENGTH] [IS_DEFAULT] [BACKEND_ID]}"
MODEL_FILE="${2:?usage: ./scripts/register-model.sh MODEL_ID MODEL_FILE [MODEL_ALIAS] [PROVIDER] [CONTEXT_LENGTH] [IS_DEFAULT] [BACKEND_ID]}"
MODEL_ALIAS="${3:-}"
