...
PLAN_CODE="${1:?usage: ./scripts/dev/create-plan.sh CODE NAME [RPM] [DAILY] [MONTHLY] [MAX_TOKENS] [ALLOW_STREAMING] [DESCRIPTION]}"
PLAN_NAME="${2:?usage: ./scripts/dev/create-plan.sh CODE NAME [RPM] [DAILY] [MONTHLY] [MAX_TOKENS] [ALLOW_STREAMING] [DESCRIPTION]}"
PLAN_RPM="${3:-10}"
PLAN_DAILY="${4:-50000}"
