...
def main():
    ...
    # Mapping definitions
    mapping = {
        "agent-shared-artifacts": {"services": ["artifact_permissions", "agent_workspace_admin"]},
        "agent-event-driven": {
            "services": [
                "cron_triggers",
                "webhook_triggers",
        ...
        "agent-tool-synthesis": {"services": ["sandbox_policy"]},
        "agent-real-connectors": {
            "services": ["connector_mode", "connector_runtime", "http_client"]
        },
        "agent-knowledge-graph": {
            "services": ["graph_policy", "graph_reasoner", "graph_extractor", "graph_models"],
            "flags": [
        ...
        "agent-execution-plane": {"services": ["agent_scheduler"]},
        "agent-tool-governance": {"services": ["sandbox_escape_analysis"]},
        "agent-readiness": {"services": ["real_execution_readiness"]},
    }
