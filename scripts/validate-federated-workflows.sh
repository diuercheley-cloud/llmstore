...
test -f control_plane/app/models/commercial_federated_workflows.py
...
grep -q "CommercialFederatedWorkflowExecution" control_plane/app/models/commercial_federated_workflows.py
...
"${PYTHON_BIN}" -m py_compile \
  control_plane/app/models/commercial_federated_workflows.py \
...
bash -n scripts/validate-federated-workflows.sh
