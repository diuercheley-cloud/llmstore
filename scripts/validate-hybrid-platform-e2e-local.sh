...
usage() {
  cat <<'USAGE'
Usage: ./scripts/validate-hybrid-platform-e2e-local.sh [options]
...
run_script "production-readiness" "Production Readiness" "${SCRIPT_DIR}/production-readiness-local.sh" "--skip-heavy"
