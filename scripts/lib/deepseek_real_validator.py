...
Usage:
  python scripts/lib/deepseek_real_validator.py --dry-run
  python scripts/lib/deepseek_real_validator.py --real --model deepseek-chat
"""
...
class DeepSeekRealValidator:
    ...
    def _format_md(self) -> str:
        lines = [
            f"# DeepSeek Real Provider Report",
            f"",
