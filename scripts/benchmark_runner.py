        ...
        if response.status_code == 200:
            ...
            result = {
                ...
                "metrics": {
                    ...
                    "latency_first_token_ms": timings.get("prompt_ms"), # Approximation for first token if n_keep=0
            ...
            print(f"Result: {result['metrics']['tokens_per_s']} t/s, {result['metrics']['vram_used_mb']} MB VRAM")
        else:
