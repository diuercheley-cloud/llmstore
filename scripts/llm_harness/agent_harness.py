"""
DEPRECATED — REMOVAL v3.0

This module (scripts/llm_harness/agent_harness.py) is deprecated since v2.0.
...
warnings.warn(
    "scripts/llm_harness/agent_harness.py is deprecated since v2.0 and will be "
    "removed in v3.0. Use 'python3 -m scripts.llm_harness.cli' instead.",
    DeprecationWarning,
    stacklevel=2,
)
