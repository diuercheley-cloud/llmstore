#!/usr/bin/env python3
# scripts/check-llm-harness-production-core.py
"""
...
def main():
    ...
    ok, stdout, stderr = run_cmd(["bash", "scripts/validate-llm-harness.sh"])
    if ok:
    ...
    e2e_path = "tests/llm_harness/test_e2e_code_mode_provider.py"
    ...
    sandbox_test_path = "tests/llm_harness/test_llm_harness_sandbox.py"
    ...
    config_test_path = "tests/llm_harness/test_llm_harness_config.py"
    ...
    matrix_test_path = "tests/llm_harness/test_provider_matrix.py"
    ...
    sanitizer_test_path = "tests/llm_harness/test_llm_harness_sanitizer.py"
    cli_test_path = "tests/llm_harness/test_llm_harness_cli.py"
