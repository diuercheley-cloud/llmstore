import os
import pytest
from control_plane.app.services.config_service import ConfigService, BaseAppConfig
...
def test_config_precedence():
    ...
    config = BaseAppConfig(database_url="sqlite:///:memory:", jwt_secret="a-long-enough-and-very-secure-secret-key-32-chars-plus")
