...
def test_validation_script_references_required_commands():
    ...
    assert "./scripts/validate-gitignore-security.sh" in content
    assert "./scripts/validate-key-files-local.sh" in content
    assert "./scripts/validate-local-permissions.sh" in content
    assert "./scripts/validate-release-artifacts-security.sh" in content
    assert "./scripts/security-report-local.sh --output-dir artifacts/security-reports" in content
