...
from app.services.security.dlp import DLPBlockException, dlp_service
...
def test_dlp_regex_matches():
    ...
    findings_aws_sec = dlp_service.scan_text_sync(
        "aws secret key: wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXUSEKEY40"
    )
    ...
    findings_aws_sec_no_context = dlp_service.scan_text_sync(
        "Here is a random 40 char string wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXUSEKEY40"
    )
