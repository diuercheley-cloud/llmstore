...
class TestDocsIndex:
    ...
    def test_index_has_architecture(self):
        content = read("docs/index.md")
        assert "## Architecture" in content

    def test_index_has_governance(self):
        content = read("docs/index.md")
        assert "## Governance" in content

    def test_index_has_federation(self):
        content = read("docs/index.md")
        assert "## Federation" in content

    def test_index_has_plugin_runtime(self):
        content = read("docs/index.md")
        assert "## Plugin Runtime" in content

    def test_index_has_supply_chain(self):
        content = read("docs/index.md")
        assert "## Supply Chain" in content

    def test_index_has_reproducible_builds(self):
        content = read("docs/index.md")
        assert "## Reproducible Builds" in content

    def test_index_has_validation(self):
        content = read("docs/index.md")
        assert "## Validation" in content

    def test_index_has_operations(self):
        content = read("docs/index.md")
        assert "## Operations" in content

    def test_index_has_disaster_recovery(self):
        content = read("docs/index.md")
        assert "## Disaster Recovery" in content

    def test_index_has_security(self):
        content = read("docs/index.md")
        assert "## Security" in content

    def test_index_has_rfcs(self):
        content = read("docs/index.md")
