...
def test_policy_conflicts_detect_allow_vs_block():
    policy = {
        "rules": [
            {"name": "allow-prod", "action": "allow_if", "conditions": [{"field": "env", "operator": "eq", "value": "prod"}]},
            {"name": "block-prod", "action": "block_if", "conditions": [{"field": "env", "operator": "eq", "value": "prod"}]},
        ]
    }
