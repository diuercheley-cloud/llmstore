...
async def test_demo_mode_inactive(
    admin_client: AsyncClient, demo_client_fixture: dict, monkeypatch
):
    from app.core.config import get_settings
...
async def test_portal_endpoints_with_demo_client(
    admin_client: AsyncClient, demo_client_fixture: dict, monkeypatch
):
    from app.core.config import get_settings
...
async def test_portal_test_chat_auth(
    admin_client: AsyncClient, demo_client_fixture: dict, monkeypatch
):
    from app.core.config import get_settings
