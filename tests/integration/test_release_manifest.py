...
def test_release_manifest_script_exists():
    assert os.path.exists("scripts/legacy/generate-release-manifest.sh")
    assert os.path.exists("scripts/release/release-local-production.sh")
...
def test_manifest_content():
    ...
    try:
        ...
        result = subprocess.run(
            [
                "bash",
                "scripts/legacy/generate-release-manifest.sh",
                "--version",
                version,
                "--artifact-dir",
                artifact_dir,
