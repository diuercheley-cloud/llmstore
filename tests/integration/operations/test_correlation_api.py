...
class TestCorrelationAPI:
    async def test_run_correlation(self, admin_client: AsyncClient, admin_token_headers: dict):
        ...
        r = await admin_client.post(
            "/admin/operations/correlations/run", json=payload, headers=admin_token_headers
        )
    ...
    async def test_correlation_risk_analysis(
        ...
        # Analyze it
        analysis_payload = {"client_id": client_id, "correlation_id": correlation_id}
        r = await admin_client.post(
