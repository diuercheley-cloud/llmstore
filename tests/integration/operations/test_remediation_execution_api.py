...
class TestRemediationExecutionAPI:
    async def test_prepare_and_execute_flow(
        ...
        prep_resp = await admin_client.post(
            "/admin/operations/remediation-executions/prepare",
            json=prep_payload,
            headers=admin_token_headers,
        )
        ...
        run_resp = await admin_client.post(
            "/admin/operations/remediation-executions/execute",
            json=exec_payload,
            headers=admin_token_headers,
        )
