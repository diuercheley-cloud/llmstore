...
def test_targets_call_scripts():
    ...
    mappings = {
        "first-run:": "./scripts/first-run-local.sh --with-demo",
        "up:": "./scripts/up.sh",
        ...
        "restore:": "./scripts/restore-local.sh $(BACKUP_DIR)",
        "upgrade:": "./scripts/upgrade-local.sh",
        "rollback:": "./scripts/rollback-local.sh",
        "benchmark:": "./scripts/benchmark-model-local.sh --quick",
        "smoke:": "./scripts/post-upgrade-smoke-local.sh",
        "clean-safe:": "./scripts/retention-local.sh --dry-run --section all"
    }
