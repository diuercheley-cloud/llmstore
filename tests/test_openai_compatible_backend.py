...
async def test_test_connection_endpoint(admin_client: AsyncClient, admin_token_headers):
    ...
    resp = await admin_client.post("/admin/backends/test-connection", json=payload, headers=admin_token_headers)
...
async def test_list_models_endpoint(admin_client: AsyncClient, admin_token_headers):
    ...
    resp = await admin_client.post("/admin/backends/list-models", json=payload, headers=admin_token_headers)
