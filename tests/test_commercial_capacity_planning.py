...
async def test_capture_capacity_snapshot_with_data():
    ...
    mock_node = MagicMock()
    mock_node.metadata_json = {"cpu_utilization": 45.0, "memory_utilization": 60.0, "gpu_utilization": 30.0}
...
async def test_forecast_capacity_growth():
    ...
    with patch("app.services.routing.commercial_capacity_forecasting.get_settings") as mock_settings:
