...
@pytest.mark.asyncio
async def test_get_latest_provider_cost_validation(mock_validation_data, admin_client, admin_token_headers):
    response = await admin_client.get("/admin/providers/cost-validation/latest", headers=admin_token_headers)
