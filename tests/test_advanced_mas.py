...
from scripts.llm_harness.mas.contracts import AgentTeam, TeamMember, AgentDefinition
...
async def test_orchestrator_debate_stop_condition(mock_registry):
    ...
    coding_loop.run = AsyncMock(return_value=ExecutionResult(success=True, message="I agree, let's stop."))
